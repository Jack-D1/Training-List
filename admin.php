...
if($_SESSION['UserID'] > 2){
    ...
    $getAllEmployees = mysqli_query($connection, "SELECT * FROM employee");
    echo "<table>";
    echo "<tr><td><b>Name</b></td><td><b>Clock No</b></td><td><b>Department</b></td><td><b>Training</b></td></tr>";
    while ($AllEmployees = mysqli_fetch_assoc($getAllEmployees)){
        echo "<tr><td>".$AllEmployees['Name']."</td><td>".$AllEmployees['ClockNo']."</td><td>".$AllEmployees['Department'].'</td><td><a href = "training.php?clock='.$AllEmployees['ClockNo'].'">View training</a></td></tr>';
    }
}
